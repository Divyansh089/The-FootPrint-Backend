...
export class SignupController {
  ...
  static async getAllSignupRequests(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async getSignupRequestById(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  static async approveSignupRequest(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  static async rejectSignupRequest(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  static async getPendingSignupRequests(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async deleteSignupRequest(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
