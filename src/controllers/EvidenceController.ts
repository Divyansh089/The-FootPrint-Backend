...
export class EvidenceController {
  private static pinataReady = false;
  private static pinataKey: string | undefined;
  private static pinataSecret: string | undefined;
  ...
  // Get all evidence
  static async getAllEvidence(req: Request, res: Response): Promise<void> {
    try {
  ...
  // Get evidence by ID
  static async getEvidenceById(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  static async getEvidenceByCaseId(req: Request, res: Response): Promise<void> {
    try {
  ...
  // Search evidence
  static async searchEvidence(req: Request, res: Response): Promise<void> {
    try {
      const { q } = req.query;
  ...
  static async uploadFileToIpfs(req: Request, res: Response): Promise<void> { // route name kept for compatibility
    try {
      const file = req.file;
      if (!file) {
  ...
  // Create evidence
  static async createEvidence(req: Request, res: Response): Promise<void> {
    try {
  ...
  const txHash = await EvidenceController.registerOnBlockchain(evidenceData.hash);
      ...
      if (autoPinMetadata) {
        try {
          await EvidenceController.pinMetadata(String((evidence as any)._id));
        } catch (metaError) {
  ...
  private static async registerOnBlockchain(hash: string): Promise<string> {
    try {
  ...
  static async getEvidenceMetadata(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  static async pinEvidenceMetadata(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  private static async pinMetadata(evidenceId: string): Promise<any> {
  ...
  private static buildEvidenceMetadata(evidence: IEvidence): any {
    const manifest = {
      hash: evidence.hash,
  ...
  // Verify metadata
  static async verifyMetadata(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async verifyEvidence(req: Request, res: Response): Promise<void> {
    try {
      const { hash } = req.body;
  ...
  // Update evidence
  static async updateEvidence(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  // Delete evidence
  static async deleteEvidence(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
